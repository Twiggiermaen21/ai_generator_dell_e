        ...
        <main className="flex flex-row bg-gray-100 dark:bg-gray-900 rounded-2xl">
            ...
            <form action={action} className="space-y-4 p-4">
                ...
                <div className="flex flex-col space-x-2 space-y-2">
                    ...
                    <Input
                        className="flex-1 px-4 py-2 rounded-md border border-gray-200 bg-white "
                    ...
                    />
                    <Button
                        className="mx-auto w-fit py-2 rounded-md bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2
                         focus:ring-blue-500 focus:ring-offset-2 "
                        type="submit"> Generate</Button>
                </div>

            </form>
            <div className="bg-white min-w-xl  rounded-md shadow-md overflow-hidden">
